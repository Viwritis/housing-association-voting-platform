...
import { InhabitantComponent } from 'app/entities/inhabitant/inhabitant.component';
...
describe('Component Tests', () => {
  describe('Inhabitant Management Component', () => {
    let comp: InhabitantComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InhabitantComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inhabitants && comp.inhabitants[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
