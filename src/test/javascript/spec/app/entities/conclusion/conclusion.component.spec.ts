...
import { ConclusionComponent } from 'app/entities/conclusion/conclusion.component';
...
describe('Component Tests', () => {
  describe('Conclusion Management Component', () => {
    let comp: ConclusionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConclusionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.conclusions && comp.conclusions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
