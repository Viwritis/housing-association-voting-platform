...
@NgModule({
  imports: [HousingAssociationVotingPlatformSharedModule, RouterModule.forChild(conclusionRoute)],
...
export class HousingAssociationVotingPlatformConclusionModule {}
