...
import pl.redheadsolutions.lg.domain.Region;
import pl.redheadsolutions.lg.service.RegionService;
...
/**
 * REST controller for managing {@link pl.redheadsolutions.lg.domain.Region}.
 */
@RestController
@RequestMapping("/api")
