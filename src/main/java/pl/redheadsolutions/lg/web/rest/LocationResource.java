...
import pl.redheadsolutions.lg.domain.Location;
import pl.redheadsolutions.lg.service.LocationService;
...
/**
 * REST controller for managing {@link pl.redheadsolutions.lg.domain.Location}.
 */
@RestController
@RequestMapping("/api")
